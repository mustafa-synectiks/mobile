				...
				<div className='bg-lightgrey container'>
							...
							<div className='btn col-sm-12 col-md-4 col-lg-4 col-xl-4 pt-3 h-100'>
								<div class='card-shadow card '>
									<a href='/foundation/index.html' className='noLine'>
										<img className='card-img-top' src={OpenPlatform} alt='Foundation' />
							...
							<div className='btn col-sm-12 col-md-4 col-lg-4 col-xl-4 pt-3 h-75'>
								<div class='card-shadow card'>
									<a href='/transformation/index.html' className='noLine'>
										<img className='card-img-top' src={Transformation} alt='Transformation' />
										<div className='card-body'>
							...
							<div className='btn col-sm-12 col-md-4 col-lg-4 col-xl-4 pt-3 h-75'>
								<div class='card-shadow card cardHeight'>
									<a href='/operations/index.html' className='noLine'>
										<img className='card-img-top' src={Solutions} alt='Operation' />
										<div className='card-body'>
					...
					<div className='cardContent'>
						<div className='text-center px-4'>
							<h3 className='pysm-5 py-2'>24x7 Operations for enterprise managed services</h3>
						</div>
						...
						<div className='py-5'>
							<div className='row justify-content-around align-items-center'>
								<div className='card card-hd mx-3'>
									...
									<div className='card-body'>
										<small className='text-center  '>
											We advise on assessment, migration, multi cloud hybrid architecture adoption
											coupled with our services, software, methodologies to accelerate enterprise
											transformation towards operation excellence.
										</small>
									</div>
								</div>
								...
								<div className='card card-hd mx-3'>
									...
									<div className='card-body'>
										<small className='text-center'>
											Synectiks xformation platform perform continuous audits on infrastructure,
											application, access management and ensure security compliances (CISP,
											HIPPA,PCI-DSS, DISA, NIST) across clouds, products and environments.
										</small>
									</div>
								</div>
								<div className='card card-hd mx-3'>
									...
									<div className='card-body'>
										<small className='text-center'>
											Synectiks xformation platform perform continuous billing monitoring across
											the accounts, services, environments, identifies capex spending and
							...
							<div className='row justify-content-around align-items-center mt-5'>
								<div className='card card-hd mx-auto mt-5'>
									...
									<div className='card-body'>
										<small className='text-center'>
											Synectiks continuous delivery platform enables you to continuously release
											new features and changes with superior quality. The delivery mechanism
											includes multiple quality gates and staged deployment, that ensures rapid
								...
								<div className='card card-hd mx-auto mt-5'>
									...
									<div className='card-body'>
										<small className='text-center'>
											Synectiks automation platform automates frequently occurring IT tasks,
											reducing IT tickets 80%. The intelligent diagnostics platform auto fixes
											more that 50% general alarms.
										</small>
									</div>
								</div>
							</div>
