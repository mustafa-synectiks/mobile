        ...
        <div class="bg-lightgrey pb-4">
          ...
          <div class="container bg-white mtn-11 partikle ">
            <div className="row mx-auto" style={s}>
              <h2 className='ch2' style={h}>Get In Touch</h2>
              <h6 className="ch6">
                <b>
              ...
              <small className="conctFon">
                We protect your privacy and don’t share personal data with third
                parties. Read our privacy notice{" "}
                <a href="https://synectiks.com/privacypolicy/index.html">
                  Here
                </a>
                .
              </small>
