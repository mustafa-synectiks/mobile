		...
		return (
			<div>
				<div className='text-center text-light fixed-bottom bg-primary content'>
					<button className=' bg-logoblue text-light  fa fa-times float-right' type='submit' id='hide' />
					<p className='mb-1 pt-2 px-3 fsize08'>
						...
						<a className=' navfont  text-light' href='/privacypolicy/index.html'>
							<small className='fsize07 text-light'>
								&nbsp;<u>Privacy&nbsp;Policy.</u>&nbsp;
							</small>
						</a>
				...
				<div className='d-sm-flex justify-content-sm-between d-md-flex  justify-content-md-between d-lg-flex justify-content-lg-between d-xl-flex justify-content-xl-between bg-footer p-5'>
					<div className='col'>
						...
						<small className='text-light'>
							We are a team of highly qualified and experienced <br /> professionals from various fields
							who are determined and dedicated to delivering world class professional services to our
							patrons.
						</small>
					</div>
					...
					<div className='col'>
						...
						<small className='text-light'>
							300 Alexander Park Drive, Suite 215, <br /> Princeton, NJ 08540 <br /> Sales: +1 (609)
							608-0429 X 102 <br /> Office: +1 (609) 608-0429
						</small>
						<br />
						<iframe
					...
					<div className='col'>
						<div>
							...
							<small className='text-light'>
								...
								<br /> Survey # 71, Madhapur, <br /> Hyderabad, IN 500 081 <br /> Office: +91 (40) 4857
								4411
							</small>
							<br />
						</div>
