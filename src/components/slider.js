...
const Slider = () => {
	return (
		<section>
			<Carousel>
				<Carousel.Item>
					<img className='d-block w-100' src={s1} alt='Synectiks Open Xformation' />
					<Carousel.Caption>
				...
				<Carousel.Item>
					<img className='d-block w-100' src={s2} alt='Enterprise Transformation' />
              ...
              >
				...
				<Carousel.Item>
					<img className='d-block w-100' src={s4} alt='Enterprise Managed Services' />
			...
			<div className='bg-lightgrey'>
				...
				<div className='container'>
					...
					<div className='row' data-aos='fade-up' data-aos-duration='2000'>
							...
							<div className='p-sm-0 py-md-2'>
								<div className='border-grey-2px cs_boxshadow'>
									<div className='img_zoom'>
										<img src={SoftwareDefinedTransformation} width='100%' alt='Enterprise-DevOps' />
									</div>
									<div className='text-group p-3 align-self-center'>
										<h4 className='font-weight-bold pt-2 text-dark'>
						...
						<a href='/realtime/index.html' className='noLine wcol-sm-12 col-md-4 my-3'>
							<div className='p-sm-0 py-md-2'>
								<div className='border-grey-2px cs_boxshadow'>
									...
									<div className='text-group p-3 align-self-center '>
										<h4 className='font-weight-bold pt-2 text-dark'>Realtime Monitoring </h4>
										<p className='text-dark'>
						...
						<a href='/storagemigration/index.html' className='noLine col-sm-12 col-md-4 my-3'>
							<div className='p-sm-0 py-md-2'>
								<div className='border-grey-2px cs_boxshadow'>
									<div className='img_zoom'>
										<img
									...
									<div className='text-group p-3 align-self-center'>
										<h4 className='font-weight-bold pt-2 text-dark'>Storage Migration </h4>
										<p className='text-dark'>
						...
						<a href='/networkdesign/index.html' className='noLine col-sm-12 col-md-4 my-3'>
							<div className='p-sm-0 py-md-2'>
								<div className='border-grey-2px cs_boxshadow'>
									...
									<div className='text-group p-3 align-self-center'>
										<h4 className='font-weight-bold text-dark'>Network Design </h4>
										<p className='text-dark'>
						...
						<a href='/storagetier/index.html' className='noLine col-sm-12 col-md-4 my-3'>
							<div className='p-sm-0 py-md-2'>
								<div className='border-grey-2px cs_boxshadow'>
									...
									<div className='text-group p-3 align-self-center'>
										<h4 className='font-weight-bold text-dark'>Storage Tier </h4>
										<p className='text-dark'>
						...
						<a href='/disasterrecovery/index.html' className='noLine col-sm-12 col-md-4 my-3'>
							<div className='p-sm-0 py-md-2'>
								<div className='border-grey-2px cs_boxshadow'>
									...
									<div className='text-group p-3 align-self-center'>
										<h4 className='font-weight-bold text-dark'>Disaster Recovery </h4>
										<p className='text-dark'>
